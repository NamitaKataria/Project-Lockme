package com.lockme.project.packag1;
import java.io.File;
...
public class LockMe {
	static File nameofFolder = new File("F://FirstProject");
	// Just one scanan is use for taking  input from user 
	...
	public static void main(String[] args) {
		...
		while (!b_exit) {
			// The menu is painted on scanreen
			outputConsole();
			try {
				// User input is read
	...
	public static void deleteFile(Scanner scandelete) {
		try {
			...
			File fileToDelete = new File(nameofFolder + "//" +
					scandelete.nextLine()+".txt");
			//On success
	...
	public static void searchFiles(Scanner scanSearch) {
		try {
			...
			File fileTofind = new File(nameofFolder + "//" +
					scanSearch.nextLine()+".txt");
			//  file existes
	...
	public static void createFile(Scanner scanCreate) {
		...
		try {
			...
			File newFile = new File( "F://FirstProject//" +scanCreate.nextLine()+".txt");
	...
	public static void outputConsole() {
		...
		System.out.println("****************************************************");
		System.out.println("*********** Designed by Namita Fontanot ***********");
		System.out.println("****************************************************");
